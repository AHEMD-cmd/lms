                ...
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full"
                            src="{{ asset($instructor->photo) ?? asset('assets/frontend/images/instructor-fallback-image.jpg') }}"
                            alt="Student thumbnail image">
                    </div>
                    <div class="media-body">
                        <h2 class="section__title fs-30">{{ $instructor->name }}</h2>
                        <span class="d-block lh-18 pt-1 pb-2">Joined
                            {{ $instructor->created_at->diffForHumans() }}</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="counter-item">
                            ...
                            <h4 class="counter__title counter text-color-4 fs-35">{{ count($instructor->courses) }}</h4>
    ...
    <section class="course-area section-padding">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between pb-3">
                ...
                <span class="ribbon ribbon-lg">{{ count($instructor->courses) }}</span>
            </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item card-preview"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><a
                                        href="javascript:void(0)">{{ $instructor->name }}</a>
                                </p>
