...
@section('content')
    ...
    <section class="register-area section--padding dot-bg overflow-hidden">
        <div class="container">
            ...
            <div class="row pt-50px" id="register-form">
                            ...
                            <form method="post" action="{{ route('become.instructor.store') }}" class="row"
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error-message text-danger" data-field="name"></span>
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error-message text-danger" data-field="email"></span>
                                        @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error-message text-danger" data-field="password"></span>
                                        @error('password')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error-message text-danger" data-field="phone"></span>
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error-message text-danger" data-field="address"></span>
                                        @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="btn-box col-lg-12">
                                    <button class="btn theme-btn" type="submit" id="submitBtn">Apply Now <i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#form').on('submit', function(e) {
                ...
                // AJAX request
                $.ajax({
                    url: '{{ route('become.instructor.store') }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    error: function(xhr) {
                        ...
                        if (Object.keys(errors).length > 0) {
                            $.each(errors, function(field, messages) {
                                // Find the error span for this field and display the first message
            ...
            $('input').on('input', function() {
                ...
                $(this).nextAll('.error-message').text('');
            });
        });
    </script>
