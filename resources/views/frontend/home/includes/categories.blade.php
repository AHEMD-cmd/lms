    ...
    <div class="container">
        ...
        <div class="category-wrapper mt-30px">
            <div class="row">
                ...
                @foreach ($categories->take(6)->shuffle() as $category)
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="{{ asset($category->image) }}"
                                data-src="{{ asset($category->image) }}" alt="Category image">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a
                                            href="">{{ $category->name }}</a>
                                    </h3>
                                    <p class="cat__meta">{{ $category->courses_count }} courses</p>
