        ...
        <div class="container">
            <div class="related-course-wrap">
                ...
                <div class="view-more-carousel-2 owl-action-styled">
                    ...
                    @foreach ($course->instructor->courses->take(6) as $instructorCourse)
                        <div class="card card-item">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title"><a href="course-details.html">{{ $instructorCourse->title }}</a>
                                </h5>
                                <p class="card-text"><a
                                        href="teacher-detail.html">{{ $instructorCourse->instructor->name }}</a>
                                </p>
    ...
    <div class="modal fade modal-container" id="previewModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <video controls crossorigin playsinline poster="{{ asset($course->image) }}" id="player">
                        <!-- Video files -->
