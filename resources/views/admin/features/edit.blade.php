...
@section('content')
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Edit Feature</h5>

            <form action="{{ route('admin.features.update', $feature->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                        id="input1" placeholder="Enter feature title" maxlength="100" required value="{{ old('title', $feature->title) }}"
                ...
                <div class="form-group col-md-6 mt-4">
                    ...
                    <select id="icon" name="icon" class="form-control icon-picker">
                        <option value="book" {{ $feature->icon === 'book' ? 'selected' : '' }}
                        ...
                        <option value="graduation-cap" {{ $feature->icon === 'graduation-cap' ? 'selected' : '' }}
                        ...
                        <option value="chalkboard-teacher" {{ $feature->icon === 'chalkboard-teacher' ? 'selected' : '' }}
                        ...
                        <option value="laptop" {{ $feature->icon === 'laptop' ? 'selected' : '' }}
                        ...
                        <option value="lightbulb" {{ $feature->icon === 'lightbulb' ? 'selected' : '' }}
                        ...
                        <option value="certificate" {{ $feature->icon === 'certificate' ? 'selected' : '' }}
                        ...
                        <option value="pencil" {{ $feature->icon === 'pencil' ? 'selected' : '' }}
                        ...
                        <option value="brain" {{ $feature->icon === 'brain' ? 'selected' : '' }}
                        ...
                        <option value="chalkboard" {{ $feature->icon === 'chalkboard' ? 'selected' : '' }}
                        ...
                        <option value="video" {{ $feature->icon === 'video' ? 'selected' : '' }}
                        ...
                        <option value="clock" {{ $feature->icon === 'clock' ? 'selected' : '' }}
                        ...
                        <option value="users" {{ $feature->icon === 'users' ? 'selected' : '' }}
                        ...
                        <option value="puzzle-piece" {{ $feature->icon === 'puzzle-piece' ? 'selected' : '' }}
                        ...
                        <option value="comments" {{ $feature->icon === 'comments' ? 'selected' : '' }}
                        ...
                        <option value="file-pdf" {{ $feature->icon === 'file-pdf' ? 'selected' : '' }}
                        ...
                        <option value="trophy" {{ $feature->icon === 'trophy' ? 'selected' : '' }}
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description"
                        placeholder="Enter description" maxlength="100" required aria-describedby="descriptionHelp" rows="3">{{ old('description', $feature->description) }}</textarea>
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
