...
<head>
	...
	<link href="{{ asset('assets/dashbiard/css/app.css') }}" rel="stylesheet">
	<link href="{{ asset('assets/dashbiard/css/icons.css') }}" rel="stylesheet">
	<title>Login</title>
</head>
				...
				<div class="row g-0">
					...
					<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        ...
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body">
                                 <img src="{{ asset('assets/dashboard/images/login-images/login-cover.svg') }}" class="img-fluid auth-img-cover-login" width="650" alt=""/>
							</div>
						</div>
							...
							<div class="card-body p-sm-5">
								<div class="">
									<div class="mb-3 text-center">
										<img src="{{ asset('assets/dashboard/images/logo-icon.png') }}" width="60" alt="">
									</div>
									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('login') }}">
                                            ...
                                            <br><br>
											{{-- <div class="col-md-6 text-end">	<a href="{{ route('dashboard.password.request') }}">Forgot Password ?</a> --}}
											</div>
											<div class="col-12">
												<div class="d-grid">
